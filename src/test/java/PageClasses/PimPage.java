...
public class PimPage extends BasePage {
   ...
   // private static String EMPLOYEE_XPATH= "//div[contains(text(), '" + employeename + "')]";
    ...
    public static void clickSaveButton(WebDriver driver) {
        ...
        log.debug("Clicked on the save button");
    }
    ...
    public static void clickAddButton(WebDriver driver) {
        ...
        log.debug("Clicked on the add button");
    }

    public static WebElement checkAddEmployee(WebDriver driver) {
    ...
    public static WebElement checkSearchEmployeeByName(WebDriver driver, String employeename) {
        ...
        try {
            cellElement = element.findElement(By.xpath(xpathExpression));
    ...
    public static void clickSearchButton(WebDriver driver) {
        ...
        log.debug("Clicked on the search button");
    }
    ...
    public static void clickDeleteButton(WebDriver driver) {
        ...
        clickWhenReady(driver, delete, 2000);
            ...
            log.debug("Clicked on the delete button");
    }catch(Exception e)
       {
           WebElement delete = tableElement.findElement(By.xpath(DELETE_BUTTON));
           clickWhenReady(driver, delete, 2000);
    ...
    public static WebElement checkDeletionPim(WebDriver driver) {
      ...
      WebDriverWait wait=new WebDriverWait(driver,Duration.ofMillis(4000));
       ...
       element= deleteSuccessMsg(driver);
        return element;
